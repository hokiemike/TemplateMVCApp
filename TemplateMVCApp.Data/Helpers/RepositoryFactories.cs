...
namespace TemplateMVCApp.Data.Helpers
{
    /// <summary>
            ...
            return new Dictionary<Type, Func<DbContext, object>>
                {
                   ...
                   //{typeof(IRepository<Room>), dbContext => new EFRepository<Room>(dbContext)},
                   //{typeof(IRepository<Track>), dbContext => new EFRepository<Track>(dbContext)},
                };
        }
